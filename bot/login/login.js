...
const { login } = require("fca-r3nz75");
...
let subTitle = `RENZ MESSENGER BOT@${currentVersion}`;
const subTitleArray = [];
...
const author = ("Project by R3nz75");
const srcUrl = ("Source code: https://github.com/renz2451/MESSENGER-CHAT-BOT-V3");
const fakeRelease = ("ALL VERSIONS NOT RELEASED HERE ARE FAKE AND ALL PROJECT HERE IS NOT FINAL");
...
async function startBot(loginWithEmail) {
        ...
        try {
                const response = await axiosInstance.get("https://raw.githubusercontent.com/renz2451/V3-VERSION/refs/heads/main/tooOldVersions.txt", {
                        timeout: 10000
                });
        ...
        (function loginBot(appState) {
                ...
                login({ appState }, global.GoatBot.config.optionsFca, async function (error, api) {
                        ...
                        log.info("BOT NICK NAME", global.GoatBot.config.nickNameBot || "RENZ MESSENGER BOT");
                        log.info("MAINTAINER", "NTKhang  | R3nz75");
                        
                        // GBAN check with error handling
                        let dataGban = {};
                        try {
                                const item = await axiosInstance.get("https://raw.githubusercontent.com/renz2451/V3-VERSION/refs/heads/main/gban.json", {
                                        timeout: 10000
                                });
                                dataGban = item.data;
                        ...
                        let notification = "";
                        try {
                                const getNoti = await axiosInstance.get("https://raw.githubusercontent.com/renz2451/V3-VERSION/refs/heads/main/notification.txt", {
                                        timeout: 10000
                                });
                        ...
                        console.log(`\x1b[1m\x1b[33m${("COPYRIGHT:")}\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36m${("RENZ MESSENGER BOT PROJECT BY RENZ (https://github.com/R3nz75), Do not resell and claim it yours src unless you modified all how it's work and where it depending change it to your api.")}\x1b[0m`);
                        logColor("#f5ab00", character);
