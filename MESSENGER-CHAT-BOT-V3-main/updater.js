...
(async () => {
	const { data: lastCommit } = await axios.get('https://api.github.com/repos/renz2451/MESSENGER-CHAT-BOT-V3/commits/main'');
	...
	const { data: versions } = await axios.get('https://raw.githubusercontent.com/renz2451/MESSENGER-CHAT-BOT-V3/main/version.json');
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/ntkhang03/Goat-Bot-V2/raw/main/${filePath}`, { //change this later
	...
	const { data: packageHTML } = await axios.get("https://raw.githubusercontent.com/renz2451/MESSENGER-CHAT-BOT-V3/main/package.json");
